...
void MainWindow::InitEventFilter()
{
    ...
    this->ui->SignInRegister_Button->installEventFilter(this);
    this->ui->SignInForget_Button->installEventFilter(this);
    this->ui->SignInOK_Button->installEventFilter(this);
    this->ui->RegisterBack_Button->installEventFilter(this);
    this->ui->ForgetBack_Button->installEventFilter(this);
    this->ui->Home_Quit_Button->installEventFilter(this);
    this->ui->RegisterOK_Button->installEventFilter(this);
...
bool MainWindow::eventFilter(QObject *obj, QEvent *event)
{
    ...
    if (obj == this->ui->SignIn_Button ||
        obj == this->ui->SignInRegister_Button ||
        obj == this->ui->SignInForget_Button ||
        obj == this->ui->SignInOK_Button ||
        obj == this->ui->RegisterBack_Button ||
        obj == this->ui->ForgetBack_Button ||
        obj == this->ui->Home_Quit_Button ||
        obj == this->ui->RegisterOK_Button ||
...
void MainWindow::Init_SignalAndSlot()
{
    ...
    //关联姓名输入框输入事件与使能注册按钮槽函数
    QObject::connect(this->ui->Name_LineEdit, SIGNAL(textChanged(QString)), this, SLOT(EnableRegisterOK_Button()));
    //关联手机号输入框输入事件与使能注册按钮槽函数
    QObject::connect(this->ui->Phone_LineEdit, SIGNAL(textChanged(QString)), this, SLOT(EnableRegisterOK_Button()));
    //关联邮箱输入框输入事件与使能注册按钮槽函数
    QObject::connect(this->ui->Email_LineEdit, SIGNAL(textChanged(QString)), this, SLOT(EnableRegisterOK_Button()));
    //关联注册密码输入框输入事件与使能注册按钮槽函数
    QObject::connect(this->ui->R_PassWord_LineEdit, SIGNAL(textChanged(QString)), this, SLOT(EnableRegisterOK_Button()));
    //关联注册确认密码输入框输入事件与使能注册按钮槽函数
    QObject::connect(this->ui->R_D_PassWord_LineEdit, SIGNAL(textChanged(QString)), this, SLOT(EnableRegisterOK_Button()));
}
